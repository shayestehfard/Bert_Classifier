...
small_train_dataset = (
    imdb["train"].shuffle(RANDOM_SEED).select([i for i in list(range(3000))])
)
small_test_dataset = (
    imdb["test"].shuffle(RANDOM_SEED).select([i for i in list(range(500))])
)
small_val_dataset = (
    imdb["test"].shuffle(RANDOM_SEED).select([i for i in list(range(500, 1000))])
)
